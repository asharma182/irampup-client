...
function speedTest() {
  ...
  window.location.replace("//129.213.169.78:8080/speedTest");
}
...
function searchModules() {
  ...
  window.location.replace("//129.213.169.78:8080/modules");
}
...
function startPreparation() {
  ...
  $('.button-options-right').hide();
  $('.option-select').append('Modules');
  window.location.replace("//129.213.169.78:8080/startPreparation");
}
...
function postureControl() {
  ...
  $('.button-options-right').hide();
  $('.option-select').append('Modules');
  window.location.replace("//129.213.169.78:8080/postureControl");
...
function goRealTime() {
  ...
  $('.button-options-right').hide();
  $('.option-select').append('Modules');
  window.location.replace("//129.213.169.78:8080/goRealTime");
...
function softSkill() {
  $('.button-options-left').hide();
  $('.button-options-right').hide();
  window.location.replace("//129.213.169.78:8080/softSkill");
...
function getAnalytics() {
  ...
  window.location.replace("//127.0.0.1:8080/userAnalytics");
