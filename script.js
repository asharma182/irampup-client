...
function searchModules() {
  ...
  window.location.replace("http://129.213.169.78:8080/modules");
}
...
function startPreparation() {
  ...
  $('.button-options-right').hide();
  $('.option-select').append('Modules');
  window.location.replace("http://129.213.169.78:8080/startPreparation");
}
...
function postureControl() {
  ...
  $('.button-options-right').hide();
  $('.option-select').append('Modules');
  window.location.replace("http://129.213.169.78:8080/postureControl");
...
function goRealTime() {
  ...
  $('.button-options-right').hide();
  $('.option-select').append('Modules');
  window.location.replace("http://129.213.169.78:8080/goRealTime");
...
function getAnalytics() {
  ...
  $('.button-options-right').hide();
  // window.location.replace("http://129.213.169.78:8080/softSkill");
  window.location.replace("http://129.213.169.78:8080/userAnalytics");
